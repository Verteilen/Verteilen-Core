...
const receivedPack = (model, record) => {
    ...
    const task = (_a = model.record.projects[model.record.project_index]) === null || _a === void 0 ? void 0 : _a.tasks[model.record.task_index];
...
class Console_Proxy {
    constructor(_model) {
        this.execute_project_start = (d) => {
            ...
            const task = (_a = this.model.record.projects[this.model.record.project_index]) === null || _a === void 0 ? void 0 : _a.tasks[this.model.record.task_index];
            const count = task.cronjob ? ((_b = task === null || task === void 0 ? void 0 : task.jobs.length) !== null && _b !== void 0 ? _b : 0) : 1;
            for (let i = 0; i < count; i++) {
...
//# sourceMappingURL=console_handle.js.map